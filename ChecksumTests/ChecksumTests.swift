...
class ChecksumTests: XCTestCase {
    ...
    func testMD5URL() {
        ...
        if let checksum = textURL.checksum(algorithm: .md5) {
    ...
    func testMD5AsyncURL() {
        ...
        imageURL.checksum(algorithm: .md5, chunkSize: chunkSize, progress: progress) { (checksum) in
            XCTAssertEqual(checksum, "89808f4076aa649844c0de958bf08fa1")
    ...
    func testMD5AsyncRemoteURL() {
        ...
        remoteImageURL.checksum(algorithm: .md5, chunkSize: chunkSize, progress: progress) { (checksum) in
            XCTAssertEqual(checksum, "89808f4076aa649844c0de958bf08fa1")
            expectation1.fulfill()
        }
    ...
    func testSHA1URL() {
        ...
        if let checksum = textURL.checksum(algorithm: .sha1) {
            XCTAssertEqual(checksum, "d0bb2056b5bdd929097dc036746cb3089613cc6e")
        }

        if let checksum = imageURL.checksum(algorithm: .sha1) {
    ...
    func testSHA224URL() {
        ...
        if let checksum = textURL.checksum(algorithm: .sha224) {
            XCTAssertEqual(checksum, "6558b657abc32403dd96b0b3d4502ec0fa98d2c1b8f2c0cefbd189e7")
        }

        if let checksum = imageURL.checksum(algorithm: .sha224) {
    ...
    func testSHA256URL() {
        ...
        if let checksum = textURL.checksum(algorithm: .sha256) {
    ...
    func testSHA512URL() {
        ...
        if let checksum = textURL.checksum(algorithm: .sha512) {
        ...
        if let checksum = imageURL.checksum(algorithm: .sha512) {
